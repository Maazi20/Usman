...
public class AddBooking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getSupportActionBar().setTitle(Html.fromHtml("<font color='#ffffff'>Friends</font>"));
        ...
        from.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getBaseContext(),AddBookingMap.class));
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_add_booking, menu);
        return true;
    }
